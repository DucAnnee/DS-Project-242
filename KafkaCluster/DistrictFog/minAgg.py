...
TARGET_TOPIC = "district1.1m.sum"
# Use a unique group_id for your consumer group
CONSUMER_GROUP_ID = (
    "district-minute-aggregator-group-py-v6"  # Incremented version for new logic
)
EXPECTED_MESSAGES_PER_MINUTE_INTERVAL = 15  # 5 houses/ward * 3 wards
        ...
        while running:
            try:
                for message in consumer:
                    ...
                    try:
                        msg_timestamp_str = data["timestamp"]
